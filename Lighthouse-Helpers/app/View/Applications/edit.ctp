<!-- File: /app/View/Applications/edit.ctp -->
...
<div class="index">
	...
	<div id="tabs">
	<?php echo $this->Form->create('Application', array('action' => 'edit', 'inputDefaults' => array('label' => false)));?>
	...
	<li><a href="#tabs-14">Confidential</a></li>
			...
			<div id="tabs-9">
				<table>
					<tr><td>CRB Disclosure:</td><td><?php echo $this->Form->select('CRB', array(1=>'No',
																								2=>'Yes',
																								3=>'Applied for'
																								)
																					) ?></td>
					<tr><td>CRB Type:</td><td><?php echo $this->Form->select('CRB_type', array('None', 
																								'Basic', 
																								'Standard', 
																								'Enhanced', 
																								'Lighthouse'
					...
					<tr><td>CRB Date:</td><td><?php echo $this->Form->input('CRB_date', array('dateFormat' => 'DMY', 
																								'timeFormat' => null, 
																								'separator' => ' ',
																								'minYear' => $data['Application']['Year'] - 6, 
																								'maxYear' => $data['Application']['Year']
																								)
																			) ?></td>
					<tr><td>CRB Number:</td><td><?php echo $this->Form->input('CRB_number') ?></td>
					<tr><td>CRB Notes:</td><td><?php echo $this->Form->textarea('CRB_note') ?></td>
				</table>
			</div>
			<div id="tabs-10">
				<table>
			...
			<div id="tabs-12">
				<table>
					<tr><th>Notes</th></tr>
					<tr>
						<td><?php echo $this->Form->input('Notes', array('rows' => '3'));?> </td>
					</tr>
				</table>
			</div>
			<div id="tabs-13">
				<table>
					<tr><th>Confirmation e-mail sent</th><th>Date</th></tr>
					<tr>
						<td><?php echo $this->Form->select('Confirmation_email_sent', array('-1'=>'Yes', '0'=>'No'))?></td>
						<td><?php echo $this->Form->input('Confirmation_email_date', array('dateFormat' => 'DMY', 
																							'separator' => ' ',
																							'minYear' => $data['Application']['Year'] - 1, 
																							'maxYear' => $data['Application']['Year']
																							)
															)?></td>
					</tr>
